...
'G15v1 Keyboard.  I don't have one, so I can't finish this, at best I can guess at it and hope and that simply isn't good enough.
' Very similar to the G15v2 class.
Namespace GLib
    Public Class G15v1Keyboard
        ...
        Friend Overrides Function DecodeGKeys(ByVal Code() As Byte) As System.Collections.Generic.List(Of Enumerations.GKeys)
            ...
            End If
            If (Code(5) And 16) = 16 Then
                PressedGKeys.Add(GKeys.G5)
            End If
            If (Code(6) And 32) = 32 Then
            ...
            End If
            If (Code(5) And 8) = 8 Then
                PressedGKeys.Add(GKeys.G10)
            End If
            If (Code(6) And 16) = 16 Then
                PressedGKeys.Add(GKeys.G11)
            End If
            If (Code(7) And 32) = 32 Then
            ...
            End If
            If (Code(5) And 64) = 64 Then
                PressedGKeys.Add(GKeys.G17)
            End If
            If (Code(8) And 64) = 64 Then
        ...
        Friend Overrides Function DecodeMKeys(ByVal Code() As Byte) As System.Collections.Generic.List(Of Enumerations.MKeys)
            ...
            If (Code(6) And 1) = 1 Then
                PressedMKeys.Add(MKeys.M1)
            End If
            If (Code(7) And 2) = 2 Then
                PressedMKeys.Add(MKeys.M2)
            End If
            If (Code(8) And 4) = 4 Then
                PressedMKeys.Add(MKeys.M3)
            End If
            If (Code(7) And 64) = 64 Then
        ...
        Friend Overrides Function DecodeSKeys(ByVal Code() As Byte) As System.Collections.Generic.List(Of Enumerations.SKeys)
            ...
            End If
            If (Code(4) And 128) = 128 Then
                PressedSKeys.Add(SKeys.Soft2)
            End If
            If (Code(5) And 128) = 128 Then
        ...
        Friend Overrides Function DecodeAKeys(ByVal Code() As Byte) As System.Collections.Generic.List(Of Keys)
